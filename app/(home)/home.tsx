...
const WelcomeText = () => {
  return (
    <View className="mb-6">
      <Text className="text-lg italic text-gray-700 text-center">Hola! Salim</Text>
      <Text className="text-2xl font-bold text-gray-800 text-center mt-0.5">Explore the Beautiful World!</Text>
    </View>
  );
};
