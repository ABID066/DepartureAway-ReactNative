  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-1 px-8">
        ...
        {/* Title */}
        <Text className="text-5xl font-bold text-center mb-12">
          Sign in
        </Text>
        ...
        <View className="flex-row justify-center items-center mb-6 mt-4">
          <TouchableOpacity 
            className={`w-5 h-5 rounded border flex items-center justify-center ${rememberMe ? 'bg-rose-500 border-rose-500' : 'border-rose-700'}`}
            onPress={() => setRememberMe(!rememberMe)}
          >
            {rememberMe && <Ionicons name="checkmark" size={12} color="white" />}
          </TouchableOpacity>
          <Text className="ml-2 text-lg font-bold text-black-700">Remember me</Text>
        </View>
        ...
        <View className="items-center mb-6">
          ...
          <View className="flex-row items-center justify-center  ">
                    ...
                    <Text className="mx-4 text-xl font-bold text-gray-500 my-4">or continue with</Text>
                    <View className="flex-1 h-px bg-gray-300"></View>
            </View>
        ...
        <View className="flex-row justify-center mt-4">
          <Text className="text-lg text-gray-500 font-medium">Don't have an account yet?  </Text>
          <TouchableOpacity onPress={() => router.push('/SignInUp/signUp')}>
            <Text className="text-xl text-blue-800 font-bold">Create Account</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
